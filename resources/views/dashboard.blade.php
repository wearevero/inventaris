<x-app-layout title="Welcome">
    <div class="flex justify-center min-h-screen dark:bg-gray-900 sm:items-center py-10 sm:pt-0">
        <div class="max-w-6xl mx-auto px-2">
            <div class="">
                <h1 class="font-display tracking-wide space-y-5 text-4xl text-geistWhite" data-aos="fade-down"
            ...
            <div class="mt-7">
                <p class="font-montreal tracking-wide text-xl text-geistWhite" data-aos="fade=down" data-aos-easing="linear"
