    ...
    <div class="px-20 my-10">
        <div class="flex justify-between my-10 items-center text-center">
            <h1 class="text-3xl font-display text-geistWhite mx-auto text-center">
                List Bagian : <span class="text-geistWhite tracking-widest">{{ $slug }}</span>
            </h1>
        </div>

        <table
            class="border-separate text-geistWhite text-center items-center border-spacing-5 w-full align-middle rounded-lg table-auto my-5">
            <thead class="">
