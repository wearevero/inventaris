<x-app-layout title="All Data">
    <div class="px-10 my-10">
        <div class="flex justify-between text-center">
            ...
            {{-- Search function --}}
            <form action="/inventaris" method="GET" class="font-montreal space-x-2">
                @csrf
        ...
        <table
            class="border-separate justify-center w-full align-middle text-geistWhite text-center items-center border-spacing-5 border-geistHightlightPurple rounded-xl my-10 border-2">
            <thead class="">
