<x-app-layout title="Detail of {{ $data->nama_user }}">
    <div class="px-20 my-20 mx-auto uppercase justify-center items-center">
        <h1 class="text-gray-700 font-display text-2xl text-center tracking-wide">THE DETAIL OF : <span class="text-black tracking-widest">{{ $data->nama_user }}</span> </h1>
        ...
        <div class="px-10">
            <button class="px-4 py-2 uppercase rounded-lg font-space hover:bg-vero hover:text-white border-4 border-vero bg-white font-bold shadow-[6px_6px_0_0] shadow-vero text-xl transition hover:shadow-none focus:outline-none focus:ring active:bg-vero">
