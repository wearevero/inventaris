                ...
                <form method="POST" action="{{ route('kategori.store') }}" class="p-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="nama_kategori" class="block mt-1 w-full" type="text" name="nama_kategori"
                            :value="old('nama_kategori')" placeholder="Notebook" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="kode_kategori" class="block mt-1 w-full" type="text" name="kode_kategori"
                            :value="old('kode_kategori')" placeholder="NB" required autofocus />
