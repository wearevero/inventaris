        ...
        <div class="flex justify-between h-16">
                    ...
                    <div class="hidden font-basement space-x-3 sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('inventaris.index')">
                                    {{ __('Status') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    ...
                    <div class="hidden font-basement space-x-3 sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link class="divide-y text-black" href="/health?fresh" target="_blank">
                                    {{ __('Check health ?') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
            ...
            <div class="hidden font-basement space-x-3 sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="left" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center tracking-wider px-3 py-2 border-2 border-transparent uppercase text-sm leading-4 font-medium rounded-md text-gray-700 border-vero bg-transparent hover:text-vero focus:outline-none transition ease-in-out duration-150">
                            <div>Tambah</div>
                            <div class="ml-1">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20">
