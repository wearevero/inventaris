<section class="space-y-6 font-montreal tracking-wide">
    <header>
        ...
        <p class="mt-1 text-lg text-gray-700">Once your account is deleted, all of its resources and data will be
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Are you sure your want to delete your
                account?</h2>
            <p class="mt-1 text-md text-gray-600 dark:text-gray-400">Once your account is deleted, all of its resources
