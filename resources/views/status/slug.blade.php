<x-app-layout title="Status {{ $slug }}">
        ...
        <div class="flex justify-between text-center">
            <div class="flex justify-between items-center mx-auto text-center">
                <h1 class="text-3xl font-display text-gray-700 mx-auto text-center">
                    List Status : <span class="text-vero tracking-widest">{{ $slug }}</span>
                </h1>
            </div>
        </div>
                ...
                @foreach ($datas as $d)
                    <tr
                        ...
                        <td class="flex text-black space-x-2 align-middle font-space items-center">
                            <button type="submit"
                                class="uppercase rounded-lg font-space hover:bg-blue-300 text-black hover:text-white border-4 border-blue-300 px-2 py-2 font-bold shadow-[4px_4px_0_0] shadow-blue-300 transition hover:shadow-none focus:outline-none focus:ring active:bg-blue-300">
